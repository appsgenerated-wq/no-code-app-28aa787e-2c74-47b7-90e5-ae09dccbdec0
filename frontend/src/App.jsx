...
function App() {
  ...
  // Initialize Manifest SDK with your App ID
  ...
  useEffect(() => {
    ...
    const testConnection = async () => {
      ...
      console.log('🔍 [APP] Backend URL:', 'https://no-code-app-28aa787e-2c74-47b7-90e5-ae09dccbdec0.vercel.app');
      console.log('🔍 [APP] App ID:', '28aa787e-2c74-47b7-90e5-ae09dccbdec0');
      ...
      if (result.success) {
        ...
        try {
          const manifest = createManifestWithLogging('28aa787e-2c74-47b7-90e5-ae09dccbdec0');
  ...
  return (
    <div>
      {currentScreen === 'landing' ? (
        ...
        // Fallback to landing if user state is somehow lost
        <LandingPage onLogin={handleLogin} />
      )}
    </div>
  );
